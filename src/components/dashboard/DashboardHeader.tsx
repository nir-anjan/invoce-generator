...
const DashboardHeader: React.FC = () => (
  <header className="flex flex-row justify-between items-center px-10 py-3 border-b border-[#E6E8EB] w-full bg-white">
    <div className="flex flex-row items-center gap-8">
      ...
      <nav className="flex flex-row gap-9">
        <span className="font-medium text-sm text-[#121417]">Dashboard</span>
        <span className="font-medium text-sm text-[#121417]">Invoices</span>
        <span className="font-medium text-sm text-[#121417]">Clients</span>
        <span className="font-medium text-sm text-[#121417]">Reports</span>
      </nav>
    </div>
    <div className="flex flex-row items-center gap-8">
      {/* Search Bar */}
      <div className="flex flex-row items-center bg-[#F2F2F5] rounded-xl overflow-hidden w-[160px]">
        <div className="flex items-center justify-center w-10 h-10 bg-[#F2F2F5] rounded-l-xl">
          <svg width="24" height="24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M20 20L17 17" stroke="#6B7582" strokeWidth="2" strokeLinecap="round" />
          </svg>
        </div>
        <input
          type="text"
      ...
      <div className="w-10 h-10 rounded-full bg-[#F2F2F5] flex items-center justify-center">
        <svg width="24" height="24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M4 20c0-2.21 3.58-4 8-4s8 1.79 8 4" stroke="#121417" strokeWidth="2" />
        </svg>
      </div>
    </div>
  </header>
